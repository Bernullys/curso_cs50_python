...
pdf = PDF()
pdf.set_title("Printing multiple columns")
pdf.set_author("Jules Verne")
pdf.print_chapter(1, "First Title", "Some_text.txt")
pdf.print_chapter(2, "Second Title", "Some_text.txt")
pdf.output("tuto_4.pdf")